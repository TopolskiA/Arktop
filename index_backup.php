...
-->
        ...
        <title>ArkTop - Photo & Graphic </title>
...
<script defer src="js/swork.js"></script>     
    </head>
    <body>
        <!--================= main start ================-->
        <div id="main">
                    ...
                    <div id="navi1" class="nav-inner isDown hide">
                        ...
                        <h2 class="v-h">MENU</h2>
                            <ul>
                                ...
                                <li><a href='portfolio' class="ajax"><h3>Portfolio<small> (w budowie)</small></h3></a></li>
                                <li><a href='galeria-photo' class="ajax"><h3>Galeria fotografii</h3></a></li>
