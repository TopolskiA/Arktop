                        ...
                        <section class="no-padding no-border">
                            ...
                            <div id="filter" class="filter-holder filter-nvis-column hide">
                                <div class="gallery-filters at">
                                    ...
                                    <a href="galeria-graphic" id="fgraphic" class="gallery-filter" onclick="dgraphic()">Grafika</a>
                                    <a href="galeria-iv" id="fwizual" class="gallery-filter gallery-filter-active" onclick="dwizual()">Identyfikacja wizualna</a>
                                </div>
                            </div>
                            <!-- filters end -->
                            <!--  filter-button-->
                            <div class="filter-button vis-fc" onclick="Filter()"><i class="fas fa-filter" aria-label="Filtrowanie"></i></div><!--  filter-button end -->
                            <!--  gallery-items -->
                            <div class="hid-port-info">
                                <!-- 1 -->
